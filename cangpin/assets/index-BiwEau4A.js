import{_ as L}from"./index-C5fuAxFq.js";import{d as A,r as i,c as x,o as m,w as h,e,b as n,aL as T,aK as U,p as E,q as C,u as R,F as I,T as M,K as $,Y as P,Z as O,cv as V,E as B,as as z,a6 as F,t as j,U as k,n as H}from"./index-D0yT1AcU.js";import{_ as D}from"./index-DYf50MRR.js";import{_}from"./index.vue_vue_type_script_setup_true_lang-CngIKbZB.js";const S={html:`<!DOCTYPE HTML>
<html>
<head>
...
`}const W={style:{display:"flex","align-items":"center","margin-bottom":"12px"}},Y={style:{flex:"1"}},K={style:{flex:"1"}},q={style:{border:"1px solid var(--el-border-color)"}},X=A({__name:"demo-basic",setup(v){const d=Object.keys(S),l=i(""),r=i("typescript"),p=i("vs-dark"),g=()=>{l.value=S[r.value]};return g(),(u,a)=>{const s=T,b=U,y=D;return m(),x(y,{header:"代码编辑器","body-style":{padding:"12px"}},{default:h(()=>[e("div",W,[a[3]||(a[3]=e("div",null,"主题：",-1)),e("div",Y,[n(b,{modelValue:p.value,"onUpdate:modelValue":a[0]||(a[0]=o=>p.value=o),class:"ele-fluid","popper-options":{strategy:"fixed"}},{default:h(()=>[n(s,{value:"vs",label:"Visual Studio"}),n(s,{value:"vs-dark",label:"Visual Studio Dark"}),n(s,{value:"hc-light",label:"High Contrast"}),n(s,{value:"hc-black",label:"High Contrast Dark"})]),_:1},8,["modelValue"])]),a[4]||(a[4]=e("div",null," 语言：",-1)),e("div",K,[n(b,{modelValue:r.value,"onUpdate:modelValue":a[1]||(a[1]=o=>r.value=o),class:"ele-fluid","popper-options":{strategy:"fixed"},onChange:g},{default:h(()=>[(m(!0),E(I,null,C(R(d),o=>(m(),x(s,{key:o,value:o,label:o},null,8,["value","label"]))),128))]),_:1},8,["modelValue"])])]),e("div",q,[n(_,{modelValue:l.value,"onUpdate:modelValue":a[2]||(a[2]=o=>l.value=o),language:r.value,theme:p.value,style:{height:"460px"}},null,8,["modelValue","language","theme"])])]),_:1})}}}),Z={style:{border:"1px solid var(--el-border-color)"}},J=A({__name:"demo-diff",setup(v){const d=i(`/**
 * 下载文件
 * @param data 二进制数据
 * @param name 文件名
 * @param type 文件类型
